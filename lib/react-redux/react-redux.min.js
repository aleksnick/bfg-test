!(function(e, t) {
  ...
  "use strict";
  var S = "default" in g ? g.default : g;
  function w(e, t) {
  ...
  var o = t(function(e) {
    ...
    i = (function(n) {
      function e(e) {
        ...
        var r = e.store;
        return (t.state = { storeState: r.getState(), store: r }), t;
      }
      w(e, n);
      var t = e.prototype;
      return (
  ...
  (a = s) && a.__esModule && Object.prototype.hasOwnProperty.call(a, "default");
  var p = t(function(e) {
      e.exports = s;
    }),
    f = {
  ...
  var T = function e(t, r, n) {
      ...
      v && (i = i.concat(v(r)));
      for (
        var a = l[t.$$typeof] || f, s = l[r.$$typeof] || f, p = 0;
        p < i.length;
        ++p
      ) {
        var c = i[p];
        if (!(d[c] || (n && n[c]) || (s && s[c]) || (a && a[c]))) {
          var u = h(r, c);
          try {
            m(t, c, u);
          } catch (e) {}
  ...
  function c(m, e) {
    ...
    var t = e.getDisplayName,
      a =
        void 0 === t
          ...
          : t,
      r = e.methodName,
      s = void 0 === r ? "connectAdvanced" : r,
      n = e.renderCountProp,
      p = void 0 === n ? void 0 : n,
      o = e.shouldHandleStateChanges,
      c = void 0 === o || o,
      i = e.storeKey,
      y = void 0 === i ? "store" : i,
      u = e.withRef,
    ...
    M(
      "store" === y,
      "storeKey has been removed and does not do anything. " + b
    );
    var O = h;
    return function(e) {
      ...
      var n = (function(u) {
        function e(e) {
          var t, o, i, a, s, p, r, n, c;
          return (
            (t = u.call(this, e) || this),
            M(
              v ? !e.wrapperProps[y] : !e[y],
              "Passing redux store in props has been removed and does not do anything. " +
                b
            ),
            (t.selectDerivedProps = function(e, t, r) {
              if (d && o === t && i === e) return a;
              r !== s && (p = m((s = r).dispatch, f));
              var n = p((i = e), (o = t));
              return a === n ? a : (a = n);
            }),
            (t.selectChildElement = function(e, t) {
              return (
                (e === r && t === n) ||
                  (c = S.createElement(l, E({}, (r = e), { ref: (n = t) }))),
                c
              );
            }),
            (t.renderWrappedComponent = t.renderWrappedComponent.bind(C(C(t)))),
            t
          );
        }
        w(e, u);
        ...
        return (
          (t.renderWrappedComponent = function(e) {
            ...
            var t,
              r = this.props;
            v && ((r = this.props.wrapperProps), (t = this.props.forwardedRef));
            var n = this.selectDerivedProps(e.storeState, r, e.store);
            return this.selectChildElement(n, t);
          }),
          (t.render = function() {
            return S.createElement(
              (this.props.context || O).Consumer,
              null,
      ...
      if (((n.WrappedComponent = e), (n.displayName = o), v)) {
        var i = S.forwardRef(function(e, t) {
          return S.createElement(n, { wrapperProps: e, forwardedRef: t });
        });
        return (i.displayName = o), (i.WrappedComponent = e), T(i, e);
      }
      return T(n, e);
    };
  }
  ...
  function j(e, t) {
    ...
    for (var n = 0; n < r.length; n++)
      if (!u.call(t, r[n]) || !O(e[r[n]], t[r[n]])) return !1;
    return !0;
  }
  function _(o) {
    return function(e, t) {
    ...
    return function(e, t) {
      ...
      return (
        ...
        (n.mapToProps = function(e, t) {
          (n.mapToProps = o), (n.dependsOnOwnProps = q(o));
          var r = n(e, t);
          return (
            "function" == typeof r &&
              ((n.mapToProps = r), (n.dependsOnOwnProps = q(r)), (r = n(e, t))),
            r
          );
        }),
        n
  ...
  function F(a, s, p, c, e) {
    ...
    function n(e, t) {
      ...
      return (
        ...
        o && i
          ? ((d = a(u, f)),
            s.dependsOnOwnProps && (l = s(c, f)),
            (m = p(d, l, f)))
          : o
          ? (a.dependsOnOwnProps && (d = a(u, f)),
            s.dependsOnOwnProps && (l = s(c, f)),
            (m = p(d, l, f)))
          : (i &&
              ((r = a(u, f)), (n = !h(r, d)), (d = r), n && (m = p(d, l, f))),
            m)
      );
    }
    return function(e, t) {
  ...
  var H,
    ...
    J,
    Q,
    X = ((U = void 0 === (K = (I = void 0 === H ? {} : H).connectHOC) ? c : K),
    (L =
      void 0 === (V = I.mapStateToPropsFactories)
        ? [
            function(e) {
        ...
        : V),
    (z =
      void 0 === (Y = I.mapDispatchToPropsFactories)
        ? [
            function(e) {
              return "function" == typeof e ? $(e) : void 0;
            },
        ...
        : Y),
    (G =
      void 0 === (B = I.mergePropsFactories)
        ? [
            function(e) {
        ...
        : B),
    (Q = void 0 === (J = I.selectorFactory) ? W : J),
    function(e, t, r, n) {
      void 0 === n && (n = {});
      var o = n.pure,
        i = void 0 === o || o,
        a = n.areStatesEqual,
        s = void 0 === a ? A : a,
        p = n.areOwnPropsEqual,
        c = void 0 === p ? j : p,
        u = n.areStatePropsEqual,
        f = void 0 === u ? j : u,
        ...
        y = k(e, L, "mapStateToProps"),
        v = k(t, z, "mapDispatchToProps"),
        h = k(r, G, "mergeProps");
      return U(
        Q,
        E(
